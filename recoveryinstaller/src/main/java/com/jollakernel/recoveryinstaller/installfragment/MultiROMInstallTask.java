...
import com.jollakernel.recoveryinstaller.UpdateChecker;
...
public class MultiROMInstallTask extends MultiROMTask {
    private static final String TAG = "MultiromInstallTask";

    MultiROMInstallTask(Manifest man, Device dev) {
        super(man, dev);
    }

    void setParts(boolean multirom, boolean recovery, String kernel) {
        m_multirom = multirom;
        m_recovery = recovery;
        m_kernel = kernel;
    }
