...
import com.jollakernel.recoveryinstaller.installfragment.Changelog;
...
public class Manifest {
    ...
    public void compareVersions(Recovery r) {
        compareVersions(r != null ? r.getVersionString() : null);
    }

    public void compareVersions(String recovery) {
        if(recovery != null) {
            try {
